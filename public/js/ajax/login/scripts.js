...
document.querySelector("#entrar-btn").addEventListener("click", () => {
  ...
  if (email === "" && senha !== "") {
    ...
    document.querySelector('.status-login').innerHTML = `<div class="alert alert-danger" role="alert">
    ...
    document.querySelector('.status-login').innerHTML = `<div class="verificando">
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (data.error) {
          ...
          document.querySelector('.status-login').innerHTML = `<div class="alert alert-success" role="alert">
